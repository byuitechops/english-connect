...
window.onload = function () {
  ...
  var currPage = document.querySelector('body').id;
  if (currPage == 'home') {
  ...
  if (currPage == 'topics') {
    breadcrumbs.innerHTML = "<a href='index.html'>Home</a> > " + skill + " Level " + level;
  }
  if (currPage == 'practices') {
    breadcrumbs.innerHTML = "<a href='index.html'>Home</a> > <a href=topics.html>" + skill + " Level " + level + "</a> > " + topic;
  }
